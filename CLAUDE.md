...
- **6 full commands**: init, setup, sync, help, status, log
- **9 thin stubs**: specify, plan, tasks, implement, commit, pr, release, audit, constitution, taskstoissues
- **1 standalone**: ship.md (from my-claude)
- **2 utility**: skill.review, ship
...
- **Per-project paths** (config, memory): `.mykit/` (relative to project root)
...
2. **Per-project config** lives in `.mykit/config.json`

...
### Step 6: Check for Speckit Conflict
...
The /mykit.tasks command is mutually exclusive with /speckit.plan.
...
To save these tasks, run: `/mykit.tasks create`
```
...
- [ ] T008 Run validation: `/mykit.validate`
- [ ] T009 Create commit: `/mykit.commit create`
- [ ] T010 Create pull request: `/mykit.pr create`
...
| `/mykit.backlog` | Select issue before creating tasks |

...
| sessionType | enum | Yes | full, lite, quickfix |
...
- If `sessionType` is invalid → Default to "full" with warning
...
|---------------|------------------------|-------------------|--------|
| specify | No | `/speckit.specify` | Create or continue specification |
| specify | Yes | `/mykit.commit create` | Commit your specification changes |
| clarify | No | `/speckit.clarify` | Continue clarification |
| clarify | Yes | `/mykit.commit create` | Commit your clarification changes |
| plan | No | `/speckit.plan` | Continue planning |
| plan | Yes | `/mykit.commit create` | Commit your planning changes |
| tasks | No | `/speckit.tasks` | Generate implementation tasks |
| tasks | Yes | `/mykit.commit create` | Commit your task changes |
| implement | No | Continue implementation or `/mykit.pr create` | Continue coding or create PR |
| implement | Yes | `/mykit.commit create` | Commit your implementation changes |
| complete | Any | `/mykit.pr create` | All tasks done, create pull request |
...
**Type**: Full workflow
**Last Command**: /speckit.implement
